...
import 'package:my_other_app/style.dart';
...
class LocationTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final textColor =
        this.darkTheme ? Style.TextColorLight : Style.TextColorDark;

    return Container(
      padding: EdgeInsets.symmetric(horizontal: Style.DefaultPaddingHorizontal),
